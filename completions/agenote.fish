...
complete -c agenote -n '__fish_use_subcommand' -f -a 'add archive commit completions config connect curate deduplicate distill doctor dream extract fields format gaps get health inbox inbox-archive init lint list memory merge reconcile reindex restore review search stats tags touch trace update viz'
