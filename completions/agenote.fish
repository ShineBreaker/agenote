...
complete -c agenote -n '__fish_use_subcommand' -f -a 'add archive commit completions config connect curate deduplicate distill doctor dream extract fields format gaps get health inbox inbox-archive init lint list memory merge reconcile reindex restore review scan-memories search stats tags touch trace update viz'
...
complete -c agenote -n '__fish_seen_subcommand_from reconcile' -l source -x -a 'claude codex crush hermes omp opencode zcode all' -d '来源'
complete -c agenote -n '__fish_seen_subcommand_from extract' -l source -x -a 'claude codex crush hermes omp opencode zcode all' -d '来源'
