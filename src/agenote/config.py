...
SCHEMA: dict[str, dict[str, Key]] = {
    ...
    "search": {
        ...
        "bm25_k1": Key(1.5, comment="BM25 词频饱和参数 k1（Okapi 标准 1.5）"),
        "bm25_b": Key(0.75, comment="BM25 文档长度归一参数 b（Okapi 标准 0.75）"),
        "title_boost": Key(2.0, comment="BM25 尺度下标题命中每词加成"),
        "phrase_boost": Key(5.0, comment="BM25 尺度下整短语命中一次加成（单域）"),
    },
    "add": {
